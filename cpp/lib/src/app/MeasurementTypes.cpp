...
BinaryOutputStatus::BinaryOutputStatus(bool value)
...
BinaryOutputStatus::BinaryOutputStatus(Flags flags, DNPTime time)
    : TypedMeasurement(flags::GetBinaryValue(flags), flags, time)
{
}

BinaryOutputStatus::BinaryOutputStatus(bool value, Flags flags)
    : TypedMeasurement(value, flags::GetBinaryFlags(flags, value))
{
}

BinaryOutputStatus::BinaryOutputStatus(bool value, Flags flags, DNPTime time)
    : TypedMeasurement(value, flags::GetBinaryFlags(flags, value), time)
{
}
...
AnalogOutputStatus::AnalogOutputStatus(double value, Flags flags, DNPTime time)
