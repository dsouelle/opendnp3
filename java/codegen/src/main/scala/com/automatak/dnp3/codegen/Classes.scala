...
object Classes {
  ...
  private def enumerations : List[ClassConfig] = List(
    ...
    classOf[StaticFrozenAnalogVariation],
    ...
    classOf[EventFrozenAnalogVariation],
  ...
  private def custom : List[ClassConfig] = List(
    ...
    ClassConfig(classOf[FrozenAnalog], Set(Features.Constructors)),
    ...
    ClassConfig(classOf[FrozenAnalogConfig], Set(Features.Fields)),
